    ...
    <main className="mx-auto grid max-w-7xl gap-5 p-4 lg:grid-cols-[minmax(0,1fr)_300px] lg:p-6">
      <Tabs value={activeTab} onValueChange={setActiveTab} className="min-w-0">
        ...
        <TabsContent value="edit" className="space-y-5">
          ...
          <Card><CardHeader><CardTitle className="text-base">Amazon identity</CardTitle></CardHeader><CardContent className="grid gap-5 sm:grid-cols-2"><div><Label>Master SKU</Label><Input className="mt-2 bg-muted/40 font-mono" value={product.sku_code} readOnly /></div><div><Label htmlFor="amazon-listing-sku">Amazon seller SKU</Label><Input id="amazon-listing-sku" className="mt-2 font-mono" value={listing.listingSku} onChange={event => update('listingSku', event.target.value.toUpperCase())} /><p className="mt-1 text-xs text-muted-foreground">Review or update before submitting to Amazon.</p></div></CardContent></Card>
