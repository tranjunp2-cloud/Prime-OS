...
const channelNames: Record<string, string> = { primeweb: 'PrimeWeb', pos: 'PrimePOS', shopee: 'Shopee', lazada: 'Lazada', tiktok: 'TikTok Shop', social: 'Social Inbox', rakuten: 'Rakuten' };
...
export default function ChannelListingDetail() {
  ...
  const [listingSku, setListingSku] = useState(`${channelKey.toUpperCase()}-${product?.sku_code ?? ''}`);
