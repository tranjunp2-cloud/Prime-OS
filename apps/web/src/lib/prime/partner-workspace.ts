...
const partnerWorkspaces: Record<PrimeRole, PartnerWorkspaceSummary> = {
  factory: {
    ...
    evidence: 'Reads CRM leads/RFQs, OMS orders, Inventory ATS, Customer repeat signals, and Finance readiness.',
  ...
  agency: {
    ...
    handoffs: [
      { label: 'Lead response', owner: 'CRM', evidence: 'Lead + RFQ queue', nextAction: 'Prepare response proof', href: '/crm/leads-rfqs?role=agency' },
  ...
  bank: {
    ...
    handoffs: [
      ...
      { label: 'Commerce source', owner: 'OMS / CRM / Inventory', evidence: 'Source-owner mapping', nextAction: 'Verify source coverage', href: '/finance/fin-support#commerce-evidence-pack' },
    ],
  },
  'lead-provider': {
    role: 'lead-provider',
    ...
    nextAction: 'Improve source quality or route warmer leads to the assigned CRM owner.',
    ...
    capabilities: [
      ...
      { label: 'Submit source context', boundary: 'Can act', detail: 'Adds attribution/evidence notes for CRM review.' },
      { label: 'Access customer records', boundary: 'Needs approval', detail: 'Private CRM and order details stay merchant-owned.' },
    ],
    handoffs: [
      { label: 'Lead quality loop', owner: 'CRM', evidence: 'Lead + RFQ conversion', nextAction: 'Tune source mix', href: '/crm/sources' },
  ...
  'creator-agency': {
    ...
    nextAction: 'Propose the next creator proof asset or escalation to CRM/Intelligence owner.',
    ...
    capabilities: [
      ...
      { label: 'Propose launch asset', boundary: 'Can act', detail: 'Submits draft proof for CRM owner approval.' },
    ...
    handoffs: [
      ...
      { label: 'Campaign activation', owner: 'CRM', evidence: 'Creator proof asset', nextAction: 'Approve campaign route', href: '/crm/content-social?view=creator-proof' },
    ],
  },
};
