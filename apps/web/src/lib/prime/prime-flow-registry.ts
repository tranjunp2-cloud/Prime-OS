...
export const primeFlowRegistry: PrimeFlowRegistryItem[] = [
  {
    ...
    failureHandling: 'Suppress weak source and route to CRM owner',
    routes: ['/crm/campaigns', '/crm/sources', '/crm/leads-rfqs', '/customer/crm-compact'],
    entities: ['Campaign', 'Lead', 'Customer', 'Product', 'SKU'],
    steps: [
      { id: 'launch', label: 'Launch campaign', route: '/crm/campaigns', reads: ['Product', 'SKU', 'Listing'], writes: ['Campaign'] },
      { id: 'capture', label: 'Capture response', route: '/crm/leads-rfqs', reads: ['Campaign'], writes: ['Lead'] },
  ...
  },
  {
    ...
    routes: ['/crm/leads-rfqs', '/ecom/cos/oms', '/ecom/cos/product-master', '/ecom/cos/inventory-brain'],
    entities: ['RFQ', 'Lead', 'Customer', 'SKU', 'Order'],
    steps: [
      { id: 'qualify', label: 'Qualify RFQ', route: '/crm/leads-rfqs', reads: ['Lead', 'SKU'], writes: ['RFQ'] },
