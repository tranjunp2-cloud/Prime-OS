        ...
        children: [
          {
            ...
            icon: RadioTower,
            children: [
              { id: 'mdec-dashboard', label: 'Dashboard', kind: 'floor', href: '/demand/mdec?view=dashboard', icon: RadioTower },
              { id: 'mdec-calendar', label: 'Calendar', kind: 'floor', href: '/demand/mdec?view=calendar', icon: Megaphone },
              { id: 'mdec-composer', label: 'Composer', kind: 'floor', href: '/demand/mdec?view=composer', icon: MessageSquareText },
            ],
          },
          {
            id: 'mdec-workflow',
            ...
            icon: Shield,
            children: [
              { id: 'mdec-approvals', label: 'Approvals', kind: 'floor', href: '/demand/mdec?view=approvals', icon: Shield, badge: '01' },
              { id: 'mdec-engagement', label: 'Engagement', kind: 'floor', href: '/demand/mdec?view=engagement', icon: BellRing, badge: '06' },
              { id: 'mdec-escalations', label: 'Escalations', kind: 'floor', href: '/demand/mdec?view=escalations', icon: ClipboardList, badge: '03' },
            ],
          },
          {
            id: 'mdec-insight',
            ...
            icon: BarChart3,
            children: [
              { id: 'mdec-analytics', label: 'Analytics', kind: 'floor', href: '/demand/mdec?view=analytics', icon: BarChart3 },
              { id: 'mdec-listening', label: 'Listening', kind: 'floor', href: '/demand/mdec?view=listening', icon: ScanSearch },
              { id: 'mdec-reports', label: 'Reports', kind: 'floor', href: '/demand/mdec?view=reports', icon: ClipboardList },
            ],
          },
        ],
      },
